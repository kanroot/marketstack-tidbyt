...
"""
arrow_up = """"""
ARROW_PROFIT = base64.decode(arrow_up)
        ...
        render.Row(
            ...
            children=[
                ...
                render.Column(
                    ...
                    children=[
                        render.WrappedText(
                            font="tb-8", align="center", content=message.upper()
                        ),
                    ],
                ),
            ],
...
def get_data_select_period(request, colors, select_period, company_name):
    ...
    change = get_percentage(list_data[0], list_data[1])
    select_period_data = []
    k = 0
            ...
            children=[
                render.Row(
                    ...
                    children=[
                        ...
                        render.Text(font = "CG-pixel-3x5-mono", content = str(change) + "%"),
                    ],
    ...
    return schema.Schema(
        ...
        fields=[
            ...
            schema.Text(
                id="entry_stock",
                name="Entry stock",
                desc="A Expermiental feature, this feature enable type price of entry",
                icon="gear",
                default="Hello",
            ),
            schema.Dropdown(
...
def is_response_error(response):
    if (
        response == ERROR_404
        or response == ERROR_429
        or response == ERROR_401
        or response == ERROR_422
        or response == ERROR_UNKNOWN
    ):
        return True
    else:
        return False
